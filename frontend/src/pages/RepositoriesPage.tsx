      ...
      <div style={{ display: 'flex', gap: 12 }}>
        ...
        <Select
          options={[
            ...
            ...['maven2','npm','docker','oci','pypi','go','nuget','helm','raw','apt','yum','cargo','conan','conda','terraform','rubygems','cran','huggingface'].map(f => ({ value: f, label: f })),
          ]}
          value={formatFilter}
  ...
  const step1 = (
    <div className={styles.form}>
      <div className={styles.formRow}>
        ...
        <Select
          options={['maven2','npm','docker','oci','pypi','go','nuget','helm','raw','apt','yum','cargo','conan','conda','terraform','rubygems','cran','huggingface'].map(f => ({ value: f, label: f }))}
          value={form.format}
