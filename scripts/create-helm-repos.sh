...
#   BLOB_STORE=s3-prod ./scripts/create-helm-repos.sh     # put everything in the "s3-prod" store
#
...
# ── 1. Hosted ─────────────────────────────────────────────────────────────────────
info "Creating Helm HOSTED repository: ${HOSTED_NAME} (blob store: ${BLOB_STORE})"
...
# ── 2. Proxy ──────────────────────────────────────────────────────────────────────
info "Creating Helm PROXY repository: ${PROXY_NAME} → ${PROXY_REMOTE} (blob store: ${BLOB_STORE})"
